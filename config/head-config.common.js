...
module.exports = {
  link: [
    ...
    { rel: "icon", type: "image/png", sizes: "192x192", href: "./assets/icon/android-chrome-192x192.png" },
  ...
  meta: [
    ...
    { name: "msapplication-TileImage", content: "./assets/icon/bus.png", "=content": true },
